...
var Service_AI = {
  /**
   * performOCR
   * สกัดข้อมูลจากรูปภาพหน้าพัสดุ (เลขพัสดุ, ชื่อผู้รับไปรษณีย์ภัณฑ์)
  ...
  performOCR: function(base64Image) {
    try {
      ...
      var payload = {
        "contents": [{
          "parts": [
            { "text": "ช่วยอ่านข้อมูลจากรูปหน้าพัสดุนี้ และตอบกลับเป็น JSON เท่านั้น โดยมีรูปแบบ: { \"trackingNumber\": \"เลขพัสดุ\", \"recipientName\": \"ชื่อผู้รับไปรษณีย์ภัณฑ์\" } หากไม่พบค่าใดให้ระบุว่าเป็น \"-\" ภาษาไทย 100%" },
            {
              "inline_data": {
